...
def fir_filter(input_data, coefficients, tape_num=20, output_length=None):
...
def main():
    ...
    output_data = fir_filter(input_data, coefficients, tape_num=20, output_length=len(input_data))
